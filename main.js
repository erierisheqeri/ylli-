...
// Command imports
const printkam = require('./commands/printkam');
...
const antiserbiaCommand = require('./commands/antiserbia.js');
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { text: 'Si prega di rendere il bot un amministratore per utilizzare i comandi di amministrazione.', ...channelInfo });
                return;
            }
            ...
            if (
                ...
                if (!isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, { 
                        text: 'Mi dispiace, solo gli admin del gruppo possono usare questo comando.',
                        ...channelInfo
                    });
                    return;
                }
        ...
        switch (true) {
            case userMessage === '.simage': {
                ...
                if (quotedMessage?.stickerMessage) {
                    ...
                    await sock.sendMessage(chatId, { text: 'Rispondi ad un adesivo con il comando .simage per convertirlo.', ...channelInfo });
                }
                break;
            }
            ...
            case userMessage.startsWith('.mute'):
                ...
                if (isNaN(muteDuration)) {
                    await sock.sendMessage(chatId, { text: 'Si prega di fornire un numero valido di minuti.\neg per silenziare 10 minuti\n.mute 10', ...channelInfo });
                } else {
            ...
            case userMessage.startsWith('.mode'):
                ...
                if (senderNumber !== settings.ownerNumber) {
                    await sock.sendMessage(chatId, { text: 'Solo il proprietario del bot può usare questo comando!', ...channelInfo });
                    return;
                }
                ...
                if (!action) {
                    ...
                    await sock.sendMessage(chatId, { 
                        text: `Modalità bot corrente: *${currentMode}*\n\nUtilizzo: .mode public/private\n\nEsempio:\n.mode public - Consenti a tutti di utilizzare il bot\n.mode private - Restrizioni al solo proprietario`,
                        ...channelInfo
                    });
                    return;
                }
                ...
                if (action !== 'public' && action !== 'private') {
                    await sock.sendMessage(chatId, { 
                        text: 'Utilizzo: .mode public/private\n\nEsempio:\n.mode public - Consenti a tutti di utilizzare il bot\n.mode private - Restrizioni al solo proprietario',
                        ...channelInfo
                    });
                    return;
                }
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `Il bot è ora in modalità *${action}*`, ...channelInfo });
                } catch (error) {
                    console.error('Error updating access mode:', error);
                    await sock.sendMessage(chatId, { text: 'Impossibile aggiornare la modalità di accesso del bot', ...channelInfo });
                }
                break;
            ...
            case userMessage === '.tagall':
                if (isSenderAdmin || message.key.fromMe) {
                    ...
                    await sock.sendMessage(chatId, { text: 'Mi dispiace, solo gli admin del gruppo possono usare il comando .tagall.', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.antilink'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { 
                        text: 'Per favore, rendi il bot un amministratore prima.',
                        ...channelInfo 
                    });
                    return;
                }
            ...
            case userMessage.startsWith('.weather'):
                ...
                if (city) {
                    ...
                    await sock.sendMessage(chatId, { text: 'Si prega di specificare una città, ad esempio, .weather London', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.welcome'):
                if (isGroup) {
                    ...
                    if (isSenderAdmin || message.key.fromMe) {
                        ...
                        await sock.sendMessage(chatId, { text: 'Mi dispiace, solo gli admin del gruppo possono usare questo comando.', ...channelInfo });
                    }
                } else {
                    await sock.sendMessage(chatId, { text: 'Questo comando può essere usato solo nei gruppi.', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { text: '*Il bot deve essere amministratore per utilizzare questa funzionalità*', ...channelInfo });
                    return;
                }
            ...
            case userMessage.startsWith('.chatbot'):
                ...
                if (!chatbotAdminStatus.isSenderAdmin) {
                    await sock.sendMessage(chatId, { text: '*Solo gli amministratori possono utilizzare questo comando*', ...channelInfo });
                    return;
                }
            ...
            case userMessage.startsWith('.play') || userMessage.startsWith('.song'):
                try {
                    ...
                    if (!text) {
                        await sock.sendMessage(chatId, { 
                            text: `❌ Si prega di fornire un termine di ricerca!\n\nEsempio: .play capri sun`,
                            ...channelInfo
                        });
                        return;
                    }
                    ...
                    await sock.sendMessage(chatId, { 
                        text: '❌ Impossibile riprodurre l\'audio! Riprova più tardi.',
                        ...channelInfo
                    });
                }
                break;
            ...
            case userMessage.startsWith('.autostatus'):
                ...
                break;
            case userMessage.startsWith('.stupra'):
                await stupreCommand.handler(XeonBotInc, chatId, message);
                break;
            default:
                if (isGroup) {
        ...
        if (chatId) {
            await sock.sendMessage(chatId, { 
                text: '❌ Impossibile elaborare il comando!',
                ...channelInfo
            });
        }
    }
